...
import Hospital from "../Pages/Dashboard/Dashboard-Login/Hospital";
import RequestBed from "../Pages/Dashboard/Main-Dashboard/GlobalFiles/RequestBed";
const AllRoutes = () => {
  return (
    <>
      <Routes>
        ...
        <Route path="/request-bed" element={<RequestBed/>}/>
        ******************** Doctor Part *************************
